			...
			if (clazz != null) {
				...
				if (instance!=null) {
					if (instance instanceof IJobHandler) {
						...
						throw new IllegalArgumentException(">>>>>>>>>>> fcy-glue, loadNewInstance error, "
								+ "cannot convert from instance["+ instance.getClass() +"] to IJobHandler");
					}
				}
			}
		}
		throw new IllegalArgumentException(">>>>>>>>>>> fcy-glue, loadNewInstance error, instance is null");
	}

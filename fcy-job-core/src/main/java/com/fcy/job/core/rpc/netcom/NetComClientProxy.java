package com.fcy.job.core.rpc.netcom;

import com.fcy.job.core.rpc.codec.RpcRequest;
import com.fcy.job.core.rpc.codec.RpcResponse;
import com.fcy.job.core.rpc.netcom.jetty.client.JettyClient;
				...
				new InvocationHandler() {
					...
					public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
						...
						if (Object.class.getName().equals(method.getDeclaringClass().getName())) {
							logger.error(">>>>>>>>>>> fcy-rpc proxy class-method not support [{}.{}]", method.getDeclaringClass().getName(), method.getName());
							throw new RuntimeException("fcy-rpc proxy class-method not support");
						}

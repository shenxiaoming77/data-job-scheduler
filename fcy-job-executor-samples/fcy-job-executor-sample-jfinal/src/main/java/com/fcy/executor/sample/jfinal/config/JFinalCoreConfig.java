package com.fcy.executor.sample.jfinal.config;

import com.fcy.executor.sample.jfinal.controller.IndexController;
import com.fcy.executor.sample.jfinal.jobhandler.DemoJobHandler;
import com.fcy.executor.sample.jfinal.jobhandler.HttpJobHandler;
import com.fcy.executor.sample.jfinal.jobhandler.ShardingJobHandler;
...
public class JFinalCoreConfig extends JFinalConfig {
	...
	private void initXxlJobExecutor() {
		...
		// load executor prop
		Prop xxlJobProp = PropKit.use("fcy-job-executor.properties");

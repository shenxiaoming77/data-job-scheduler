package com.fcy.job.admin.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.fcy.job.admin.core.model.XxlJobGroup;
import com.fcy.job.admin.core.model.XxlJobInfo;
import com.fcy.job.admin.core.route.ExecutorRouteStrategyEnum;
import com.fcy.job.admin.core.schedule.XxlJobDynamicScheduler;
...
import com.fcy.job.admin.dao.XxlJobLogGlueDao;
import com.fcy.job.admin.service.XxlJobService;
import com.fcy.job.core.biz.model.ReturnT;
import com.fcy.job.core.enums.ExecutorBlockStrategyEnum;
import com.fcy.job.core.glue.GlueTypeEnum;
...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public ReturnT<String> add(XxlJobInfo jobInfo) {
		...
		if (StringUtils.isNotBlank(jobInfo.getChildJobId())) {
	                JSONObject childjson = JSONObject.parseObject(jobInfo.getChildJobId());
	                for(Object  childJobIdItem: childjson.values()){
				XxlJobInfo childJobInfo = xxlJobInfoDao.loadById(Integer.parseInt(childJobIdItem.toString()));

package com.fcy.job.admin.core.schedule;

import com.fcy.job.admin.core.jobbean.RemoteHttpJobBean;
import com.fcy.job.admin.core.model.XxlJobInfo;
import com.fcy.job.admin.core.thread.JobFailMonitorHelper;
import com.fcy.job.admin.core.thread.JobRegistryMonitorHelper;
import com.fcy.job.admin.core.thread.JobTriggerPoolHelper;
import com.fcy.job.admin.core.util.I18nUtil;
import com.fcy.job.admin.dao.XxlJobGroupDao;
import com.fcy.job.admin.dao.XxlJobInfoDao;
import com.fcy.job.admin.dao.XxlJobLogDao;
import com.fcy.job.admin.dao.XxlJobRegistryDao;
import com.fcy.job.core.biz.AdminBiz;
import com.fcy.job.core.biz.ExecutorBiz;
import com.fcy.job.core.enums.ExecutorBlockStrategyEnum;
import com.fcy.job.core.rpc.netcom.NetComClientProxy;
import com.fcy.job.core.rpc.netcom.NetComServerFactory;
...
public final class XxlJobDynamicScheduler implements ApplicationContextAware {
    ...
    public void init() throws Exception {
        ...
        logger.info(">>>>>>>>> init fcy-job admin success.");
    }
